...
'   <div id="page">'.
'    <div class="width100">'.
'        <button class="dark-mod"><i class="fas fa-adjust"></i></button>'.
'        <div class="container">'.
'            <div id="header">'.
...
'                    <input class="input-search" type="text" placeholder="Nhập tên bộ phim mà bạn đang muốn tìm kiếm">'.
...
'                        <a href="./register.php"><i class="fa-solid fa-registered"></i>Đăng kí</a>'.
'                    </div>'.
...
'                </div>'.
'            </div>'.
'            <div id="menu" class="menu-responsive-mobile">'.
''.
...
'                    <div class="content-trending content-search">'.
...
'                            <div class="title-box">'.
'                                <a href="./infomationFirm.html"><h2>Phim cập nhật</h2></a>'.
'                                <a href="./infomationFirm.html">Phim hấp dẫn</a>'.
...
'                                    <a href="./infomationFirm.html"><img src="https://bichill1.org/wp-content/uploads/2023/03/egdSHzUhegm3sBOIxFQnSDx27il-283x400.jpg" alt=""></a>'.
'                                </div>'.
...
''.
'   </div>'.
'   <script src="./assets/js/showDataFirm.js"></script>'.
'   <script src="./assets/js/app.js"></script>'.
'   <script src="./assets/js/drark-mod.js"></script>'.
'   <script src="./assets/js/showDataInforFirm.js"></script>'.
'   <script src="./assets/js/search.js"></script>'.
'   <script src="./assets/js/dataFilm.js"></script>'.
'   <script src="./assets/js/dataFilm2.js"></script>'.
'</body>'.
'</html>';
